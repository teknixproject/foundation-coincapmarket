    ...
    <div className="bg-white text-black min-h-screen py-12 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-8">
          <a
            href="https://www.freeprivacypolicy.com/live/9de353c-eb2f-4555-90"
            className="underline text-blue-600"
          >
            https://www.freeprivacypolicy.com/live/9de353c-eb2f-4555-90
          </a>
        </p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            <li>
              By email:{' '}
              <a href="mailto:support@coincapmarket.com" className="underline text-blue-600">
                support@coincapmarket.com
              </a>
            </li>
            <li>
              By visiting this page on our website:{' '}
              <a href="https://support.coincapmarket.com" className="underline text-blue-600">
                https://support.coincapmarket.com
              </a>
            </li>
          </ul>
        </section>
